...
st.text("Abaixo é mostrado quantos CNPJ's o regime tributário é do tipo 'Lucro real no estado da Paraíba entre os anos de 2014 e 2021'. Os dados estão disponíveis no portal de dados abertos do gverno federal")
